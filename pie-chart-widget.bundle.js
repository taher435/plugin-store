...
var PieChartWidgetComponent = /** @class */ (function () {
    function PieChartWidgetComponent() {
    }
    PieChartWidgetComponent.prototype.ngOnInit = function () {
    };
    PieChartWidgetComponent = __decorate([
        core.Component({
            selector: 'gc-pie-chart-widget',
            template: "\n    <p>\n      pie-chart-widget works!\n    </p>\n  ",
            styles: []
        }),
...
var PieChartWidgetModule = /** @class */ (function () {
    function PieChartWidgetModule() {
    }
    PieChartWidgetModule = __decorate([
        core.NgModule({
            ...
            // exports: [PieChartWidgetComponent],
            entryComponents: [PieChartWidgetComponent]
        })
    ], PieChartWidgetModule);
    return PieChartWidgetModule;
}());

exports.PieChartWidgetModule = PieChartWidgetModule;
